...
Besides implementation, the project should include the following documentation and analysis artifacts:
...
These deliverables are important for explaining system behavior, design decisions, and module interaction.
